...
// These tests use getBlock13b8a() which provides hardcoded block data from
// Legacy Bitcoin mainnet (block 0000000000013b8ab2cd513b0261a14096412195a72a0c4827d229dcc7e0f7af).
// BATHRON has different block serialization format, causing deserialization errors.
// Re-enable when BATHRON-specific test blocks are created.
//
...
#if 0 // DISABLED: Legacy Legacy block tests - not applicable to BATHRON
...
#endif // DISABLED: Legacy Legacy block tests
