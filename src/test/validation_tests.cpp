...
#if 0 // DISABLED: Sapling validation test
// This test validates Sapling transaction rejection reasons. The expected
// rejection message "bad-txns-invalid-sapling" has been modified in BATHRON.
// Since this is Sapling-specific functionality, disable until Sapling
// integration is fully validated. Belongs in sapling_* test suite.
...
BOOST_FIXTURE_TEST_CASE(test_simple_shielded_invalid, TestingSetup)
{
    ...
    }
    {
        ...
        // Create a test transaction with shielded spend
        CTxIn vin;
...
#endif // DISABLED: Sapling validation test
