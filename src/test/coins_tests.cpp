...
#if 0 // DISABLED: Legacy hardcoded serialization vectors
// These hex blobs were generated from legacy Coin serialization format.
// BATHRON uses the same Coin::Serialize (code = nHeight*2 + fCoinBase) but
// the expected values (nHeight=59807, fCoinBase=true) don't match the
// hex vectors. Regenerate vectors for BATHRON or remove this test.
...
#endif // DISABLED ccoins_serialization
