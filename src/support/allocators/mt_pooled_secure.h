...
#ifndef BATHRON_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
#define BATHRON_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
...
#endif // BATHRON_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
