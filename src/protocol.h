...
/**
 * The qfcommit message is used to propagate quorum final commitments
 */
extern const char* QFCOMMITMENT;
/**
 * The qsendrecsigs message is used to propagate quorum intra-quorum partial recovered signatures
 */
...
/*
 * Messages for quorum inter-quorum communication (deprecated)
 */
...
enum GetDataMsg {
    ...
    MSG_MASTERNODE_PING,
    MSG_DSTX, // Deprecated
    // HU: Legacy quorum types deprecated - kept for backward compatibility
    MSG_QUORUM_FINAL_COMMITMENT,  // Deprecated
    MSG_QUORUM_CONTRIB,           // Deprecated
    MSG_QUORUM_COMPLAINT,         // Deprecated
    MSG_QUORUM_JUSTIFICATION,     // Deprecated
    MSG_QUORUM_PREMATURE_COMMITMENT, // Deprecated
    MSG_QUORUM_RECOVERED_SIG,     // Deprecated
    MSG_CLSIG,                    // Deprecated
    // PIVHU: New HU finality message type
    MSG_HU_SIGNATURE,             // HU finality signature (ECDSA, 8/12 quorum)
    MSG_TYPE_MAX = MSG_HU_SIGNATURE,
};
