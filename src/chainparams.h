...
public:
    ...
    enum Bech32Type {
        ...
        OPERATOR_SECRET_KEY,   // HU: ECDSA operator key
        OPERATOR_PUBLIC_KEY,   // HU: ECDSA operator key
    ...
    /** How long to wait until we allow retrying of a quorum connection */
    int QuorumConnectionRetryTimeout() const { return nQuorumConnectionRetryTimeout; }
...
protected:
    ...
    // Tier two
    int nQuorumConnectionRetryTimeout;
