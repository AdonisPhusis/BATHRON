...
By default, bathrond will dump mempool on shutdown and
...
class MempoolPersistTest(BathronTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent bathrond from writing mempool.dat to disk. Verify that `savemempool` fails")
