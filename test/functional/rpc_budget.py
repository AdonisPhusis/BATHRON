...
class BudgetProposalTest(BathronTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test with invalid BATHRON address")
        assert_raises_rpc_error(-5, "Invalid BATHRON address", self.nodes[0].preparebudget,
