...
from test_framework.test_framework import BathronTestFramework, SkipTest
...
class ZMQTest (BathronTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that bathron has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("bathrond has not been built with zmq enabled.")
