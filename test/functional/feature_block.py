...
class FullBlockTest(BathronTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure bathrond isn't accepting b26
        ...
        # Extend the b28 chain to make sure bathrond isn't accepting b28
        ...
        # BATHRON: timestamp checks disabled for regtest
        ...
        #    Low-S and High-S values (whereas the bathron code has custom code which does so);
