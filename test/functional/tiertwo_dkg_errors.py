#!/usr/bin/env python3
# Copyright (c) 2021-2022 The BATHRON Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test errors during DKG phases"""

from test_framework.test_framework import BathronDMNTestFramework, ExpectedDKGMessages
...
class DkgErrorsTest(BathronDMNTestFramework):

    def set_test_params(self):
        self.set_base_test_params()
        self.extra_args = [["-nuparams=v5_shield:1", "-nuparams=BATHRON_v5.5:130", "-nuparams=v6_evo:130", "-debug=llmq", "-debug=dkg", "-debug=net"]] * self.num_nodes
