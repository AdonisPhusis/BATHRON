...
class DIP3Test(BathronTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-5, "invalid BATHRON address InvalidPayee",
        ...
        assert_raises_rpc_error(-5, "invalid BATHRON address InvalidPayee", controller.protx_update_registrar,
